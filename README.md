...
A C-code software is implemented to interface with the hardware that returns number of counts as a function of bin index. The counting is performed in time bins of width 10 $\mu$s. A brief description of the implementation is described next.
